...
export default function ProductsList() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await fetch(`http://localhost:3000/admin/product/page/${page}`);
                ...
                return (
                    <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-50 flex items-center justify-center">
                        <div className="bg-white p-6 rounded shadow-md w-full max-w-sm text-center">
                            ...
                            <p className="mb-6 text-gray-600">Bạn có chắc muốn xóa sản phẩm này không?</p>
                            <div className="flex justify-center space-x-4">
                                <button
                                    onClick={async () => {
                                        try {
                                            const response = await fetch(`http://localhost:3000/admin/product/${id}`, {
                                                method: 'DELETE'
                                            });
