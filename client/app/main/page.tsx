        ...
        <div className="w-full h-[500px] relative rounded-xl overflow-hidden my-6">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start z-20 p-16">
            ...
            <div className="flex gap-4">
              <Link href="/main/product" className="bg-white text-gray-800 px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors">
                Mua Ngay
              </Link>
              <Link href="/main/product?hot=1" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition-colors">
                Khám Phá Thêm
              </Link>
            </div>
          </div>
        ...
        <section className="py-16 px-4 bg-white rounded-xl my-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="flex flex-col items-center">
              ...
              <Link href="/main/product?category=phone" className="mt-4 text-blue-600 font-medium hover:underline">
                Xem Điện Thoại
              </Link>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <Link href="/main/product?category=laptop" className="mt-4 text-blue-600 font-medium hover:underline">
                Xem Laptop
              </Link>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <Link href="/main/product?category=watch" className="mt-4 text-blue-600 font-medium hover:underline">
                Xem Đồng Hồ
              </Link>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <Link href="/main/product?category=headphone" className="mt-4 text-blue-600 font-medium hover:underline">
                Xem Tai Nghe
              </Link>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <Link href="/main/product" className="bg-gray-800 text-white px-8 py-3 rounded-full font-semibold hover:bg-gray-900 transition-colors">
              Xem Tất Cả Sản Phẩm
            </Link>
          </div>
        </section>
        ...
        <section className="py-8 px-4 flex gap-6 pt-26" ref={productRef}>
          <aside className="bg-white p-4 shadow-md w-1/4 rounded">
            ...
            <div className="mb-4">
              ...
              <Link href="/main/product" className="text-blue-500 hover:underline">Xem ngay</Link>
            </div>
            <div>
              <h4 className="font-medium mb-4">Mua nhiều</h4>
              <Link href="/main/product?sort=popular" className="text-blue-500 hover:underline">Xem ngay</Link>
            </div>
          </aside>
