...
export default function CategoryProductsPage() {
    ...
    const handleSortChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        const newUrl = params.id
            ? `/main/product/bycategory/${params.id}?${queryParams.toString()}`
            : `/main/product/bycategory?${queryParams.toString()}`;
        router.push(newUrl);
    };
    ...
    useEffect(() => {
        ...
        const newBaseUrl = categoryId ? `/main/product/bycategory/${categoryId}` : `/main/product/bycategory`;
