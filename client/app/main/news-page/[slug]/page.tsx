      ...
      <div className="bg-white border-b">
        <div className="max-w-[1400px] mx-auto px-4 py-4">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            <Link href="/main" className="hover:text-blue-600">Trang chủ</Link>
            <span>/</span>
            <Link href="/main/news-page" className="hover:text-blue-600">Tin tức</Link>
            <span>/</span>
              ...
              <div key={i.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  <h3 className="font-bold mb-2 hover:text-blue-600">
                    <Link href={`/main/news-page/${i.slug}`}>
