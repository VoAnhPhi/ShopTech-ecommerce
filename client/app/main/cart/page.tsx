                ...
                <div>
                    ...
                    <div className="bg-white rounded-lg shadow p-6 mb-6">
                        ...
                        <div className="flex flex-col sm:flex-row justify-between gap-4">
                            <Link href="/main" className="bg-white border border-gray-300 px-6 py-3 rounded-md text-center hover:bg-gray-50">
                                Tiếp tục mua hàng
                            </Link>
                            <Link href="/main/cart/checkout" className="bg-gray-800 text-white px-6 py-3 rounded-md text-center hover:bg-gray-900">
                                Thanh toán
                            </Link>
                        </div>
                    </div>
